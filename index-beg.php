...
of digital assets'>
		...
		<div class="first_section_video_btn_wrapper">
			<div class="first_section_video_btn video_btn_js" onclick='window.open("https://demo.membrana.io/")'>
        ...
        <div class="">
            <div class="first_section_ether">
                ...
                <div class="first_section_ether_info">
                    ETH adress: 0x19d60ee939595539632ab88a72688df2051cc43a <br />
                    Current Price: 1 MCS = $0,07
                </div>
                <div id="clockdiv" class="count-down progress" data-deadline="02/20/2018 23:59:59">
                ...
                <div class="six_section_btn_wrapper">
                    <a href="#modalinfo"  rel="modal:open" class="six_section_btn">Contribute Now</a>
                </div>
                <br>
                <br>
                <br>
                <div class="first_section_ether_polosa" id="polosa" data-eht="0x19d60ee939595539632ab88a72688df2051cc43a" data-min="0" data-max="500000" data-avg="300000">
                    <span class="first_section_ether_polosa_inner">150 000</span>
                    <span class="first_section_ether_polosa_min">0</span>
                    <span class="first_section_ether_polosa_avg">300 000 USD<span>soft cap</span></span>
                    <span class="first_section_ether_polosa_max">500 000 USD<span>hard cap</span></span>
                </div>
                <div class="first_section_ether_readfaq">
                    <div class="section_readfaq" id="readfaq">
                    ...
                    <a href="#readfaq" class="js_readfaq">Read FAQ</a> &nbsp; <a href="#" class="how">How to Contribute</a>
                </div>
            </div>
...
<div class="all_sections_wrapper section fp-auto-height-responsive">
	...
	<div class="six_section_wrapper section_wrapper_js  section" data-section-index="4">
		...
		<img class="small_pattern_10 small_pattern" src="img/small_pattern_10.png" width="70" onerror="this.onerror=null; this.src='img/small_pattern_10.png'" >
		<img class="small_pattern_11 small_pattern" src="img/small_pattern_11.png" width="87" onerror="this.onerror=null; this.src='img/small_pattern_11.png'" >
			...
			<div class="our_team_wrapper">
				<div class="our_team_string">
					<div class="our_team_item">
						<div class="our_team_img_wrapper">
							<img class="our_team_img" src="img/uploads/evgeniy_buev.jpg" alt="" title="">
						</div>
					...
					<div class="our_team_item">
						<div class="our_team_img_wrapper">
							<img class="our_team_img" src="img/uploads/maxim_khukhro.jpg" alt="" title="">
						</div>
						<div class="our_team_position">
				...
				<div class="our_team_string our_team_string2">
					...
					<div class="our_team_item">
						...
						<div class="our_team_position">
							<div class="our_team_position_text">Backend and Solidity Developer</div>
						</div>
						<div class="our_team_name">
							<div class="our_team_name_text">Igor Knyazev</div>
						</div>
						<div class="our_team_description">
					...
					<div class="our_team_item">
						...
						<div class="our_team_position">
							<div class="our_team_position_text">Frontend and Mobile App Developer</div>
						</div>
						<div class="our_team_name">
							<div class="our_team_name_text">Vyacheslav Mychkin</div>
						</div>
						<div class="our_team_description">
			...
			<div class="our_team_wrapper">
				...
				-->
					<div class="our_team_item">
						...
						<div class="our_team_name">
							<div class="our_team_name_text">Kushed</div>
						</div>						
						<div class="our_team_description">
							<div class="our_team_description_text" onclick="window.open('https://bitcointalk.org/index.php?topic=1317448.0')"><span class="clickable">The founder of SaluS (SLS)</span>. Crypto trader since 2013. Oldschool and trustable bitcointalk member.</div>
						</div>
						<div class="social_networks_wrapper">
